...
def main():
    ...
    model = BertForTokenClassification.from_pretrained("SIKU-BERT/sikubert", num_labels=2).to(device)  # type: ignore
    ...
    model_save_dir = "/media/disk2/wangzhaoji/Projects/tongjiazi-dataset-baseline/models/tasks/TongjiaziDetectionSikuBert/saved"
