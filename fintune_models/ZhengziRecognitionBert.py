...
def main():
    ...
    model = BertForMaskedLM.from_pretrained(
        "/media/disk2/wangzhaoji/Projects/tongjiazi-dataset-baseline/models/default/bert/DaizhigeBert").to(device)  # type: ignore
    ...
    model_save_dir = "/media/disk2/wangzhaoji/Projects/tongjiazi-dataset-baseline/models/tasks/ZhengziRecognitionBert/saved"
