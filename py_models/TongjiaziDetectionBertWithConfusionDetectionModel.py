...
class TongjiaziDetectionBertWithConfusionDetectionModel(BaseDetectionModel):
    model_path: str
    ...
    def __detect(self, sentence: str) -> 'List[int]':
        ...
        pos_list_via_confusion = []
        for pos in pos_list:
            c = sentence[pos]
            if c in self.confusion_dict:
                pos_list_via_confusion.append(pos)
        return pos_list_via_confusion
